                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic">
                                <img src="{{ asset('storage/product/' . $related->foto_produk) }}" alt="{{ $related->nama_produk }}">
                                <ul class="product__item__pic__hover">
                                    <li><a href="{{ route('shop.show', $related->id) }}"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a href="#">{{ $related->nama_produk }}</a></h6>
