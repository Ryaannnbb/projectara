 ...
 <body>
     ...
     <section class="about-section">
         ...
         <div class="about-content">
             ...
             <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ac efficitur dui. Praesent dui erat, porttitor nec ante id, aliquam finibus dolor. Sed luctus neque a nunc dignissim euismod. Sed ultrices eo tortor fermentum lacinia.</p>
             <p>Vivamus et lectus lacus. Phasellus tincidunt orci quis nisi aliquet imperdiet. Nunc at urna leo posuere pharetra vitae consectetur eros. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
         </div>
     </section>
     ...
     <section class="visi-misi-section">
         <div class="visi-misi-content">
             <h2>VISI</h2>
             <p>Vivamus at lectus lacus. Phasellus tincidunt orci quis nisi aliquet imperdiet. Nunc at urna a leo posuere pharetra vitae consectetur eros. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
     ...
     <footer class="bg-primary text-white py-4">
         <div class="container">
             <div class="row d-flex justify-content-between">
                 ...
                 <div class="col-md-6">
                     <h3>Let's Talk</h3>
                     <p>Every project starts with a chat. Joven leads our client conversations and will be happy to discuss your project. He will also pull in the right people from the team when needed.</p>
                 </div>
