    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ request()->routeIs('kategori') ? 'active' : '' }}" href="{{ route('kategori') }}" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('spices') ? 'active' : '' }}" href="{{ route('spices') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span data-feather="pie-chart"></span>
                            </span>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('seeds') ? 'active' : '' }}" href="{{ route('seeds') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span data-feather="pie-chart"></span>
                            </span>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('nuts') ? 'active' : '' }}" href="{{ route('nuts') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span data-feather="pie-chart"></span>
                            </span>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('special_products') ? 'active' : '' }}" href="{{ route('special_products') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon mt-1">
                                <span data-feather="pie-chart"></span>
                            </span>
                            <span class="nav-link-text">Special Product</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('store_locations') ? 'active' : '' }}" href="{{ route('store_locations') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon mt-1">
                                <span data-feather="pie-chart"></span>
                            </span>
                            <span class="nav-link-text">Store Locations</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item">
