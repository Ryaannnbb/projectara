    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('special_products') ? 'active' : '' }}"
                        href="{{ route('special_products') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('store_locations') ? 'active' : '' }}"
                        href="{{ route('store_locations') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon mt-1">
                                <span data-feather="pie-chart"></span>
                            </span>
            ...
            <a class="navbar-brand me-1 me-sm-3" href="../../../index.html">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img
                            src="{{ asset('img/storyset/WhatsApp_Image_2024-12-05_at_12.20.38-removebg-preview.png') }}"
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="card-footer p-3 border-top">
                            <div class="d-flex flex-column align-items-center">
                                <!-- Perubahan untuk menempatkan secara vertikal -->
                                <div class="mb-3">
                                    <!-- Menambahkan margin bottom untuk memberikan jarak antara gambar profil dan tombol log out -->
                                    <a class="btn btn-phoenix-secondary d-flex flex-center"
                                        href="{{ route('logout') }}">
