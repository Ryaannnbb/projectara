...
@section('title', 'List Special Product')
...
<div class="content">
    <div class="mb-9">
        <div class="row g-3 mb-4">
            <div class="col-auto">
                <h2 class="mb-0">Special Product</h2>
            </div>
        </div>
        <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">
                    <span>All</span>
                    <span class="text-700 fw-semi-bold">({{ $specialProduct->count() }})</span>
                </a>
            </li>
        </ul>
        <div id="products"
            ...
            <div class="mb-4">
                <div class="d-flex flex-wrap gap-3">
                    <div class="ms-xxl-auto">
                        <a href="{{ route('special_products.create') }}" class="btn btn-primary" id="addBtn">
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal{{ $item->id }}">
                                        <img src="{{ asset('storage/special_products/' . $item->foto_produk) }}" alt="" width="53" />
                                    </a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img src="{{ asset('storage/special_products/' . $item->foto_produk) }}" alt="" class="img-fluid" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                    <div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a class="dropdown-item" href="{{ route('special_products.edit', $item->id) }}">Edit</a>
                                            <div class="dropdown-divider"></div>
                                            <form action="{{ route('special_products.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
