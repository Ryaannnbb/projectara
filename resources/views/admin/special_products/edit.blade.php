    ...
    <div class="content">
        <form class="mb-9" action="{{ route('special_products.update', $specialProduct->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 flex-between-end mb-5">
                <div class="col-auto">
                    <h2 class="mb-2">Edit Special Product Produk</h2>
                    <h5 class="text-700 fw-semi-bold">Silakan lengkapi form di bawah ini untuk mengedit produk.</h5>
                </div>
                <div class="col-auto">
                    <a class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0" href="{{ route('special_products') }}">Batalkan</a>
                ...
                <div class="col-12 col-xl-8">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama_produk') is-invalid @enderror" id="namaProduk"
                            ...
                            value="{{ old('nama_produk', $specialProduct->nama_produk) }}" />
                        @error('nama_produk')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsiProduk" name="deskripsi"
                            rows="5" placeholder="Masukkan Deskripsi Produk">{{ old('deskripsi', $specialProduct->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <strong class="invalid-feedback">{{ $message }}</strong>
                        @enderror
                    </div>
                                                    ...
                                                    @else
                                                        @foreach ($kategori as $kategoris)
                                                            <option value="{{ $kategoris->id }}"
                                                                {{ old('kategori_id', $specialProduct->kategori_id) == $kategoris->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-12">
                                            <div class="mb-4">
                                                ...
                                                <input class="form-control @error('berat') is-invalid @enderror"
                                                    ...
                                                    name="berat" value="{{ old('berat', $specialProduct->berat) }}" />
                                                @error('berat')
                                                    <strong class="invalid-feedback">{{ $message }}</strong>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-12">
                                            <div class="mb-4">
                                                ...
                                                <input class="form-control @error('harga') is-invalid @enderror"
                                                    ...
                                                    name="harga" value="{{ old('harga', $specialProduct->harga) }}" />
                                                @error('harga')
                                                    <strong class="invalid-feedback">{{ $message }}</strong>
                                                @enderror
                                            </div>
