...
@section('main')
    <div class="content">
        <form class="mb-9" action="{{ route('kategori.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-5">
                <div class="col-12 col-xl-12">
                    ...
                    <input class="form-control @error('nama_kategori') is-invalid @enderror" type="text" placeholder="Masukkan Nama Kategori" name="nama_kategori" id="namaKategori" value="{{ old('nama_kategori') }}"/>
                    @error('nama_kategori')
